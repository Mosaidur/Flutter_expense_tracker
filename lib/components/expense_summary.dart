...
class ExpenseSummary extends StatelessWidget {
  ...
  double calculateMax(
    ...
    values.sort();
    //get largest amount (which is the end of the sorted List)
  ...
  Widget build(BuildContext context) {
    ...
    //get yyyymmdd for each day of this weak
    ...
    return Consumer<ExpenseData>(
      ...
      Column(
        children: [
          ...
          SizedBox(height:20 ,),
          Text("Weekly Total : ${calculateWeektotal(value, sunday, monday, tuesday, wednesday, thursday, friday, saturday,)} Taka",
            style: TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.bold,
            ),
